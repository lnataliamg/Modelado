import java.util.*;
public abstract class Youtube implements IServicio{
    private int monto;
    protected List<Usuario> usuarios;
    protected String ultimoSuceso;

	/**
	* Default empty Youtube constructor
	*/
	public Youtube() {
		super();
	}
	...
	/**
	* Default Youtube constructor
	*/
	public Youtube(int monto, List<Usuario> usuarios) {
		super();
		this.monto = monto;
