import java.util.*;
public abstract class Spotify implements IServicio{
    private int monto;
    protected List<Usuario> usuarios;
    protected String ultimoSuceso;

	/**
	* Default empty Spotify constructor
	*/
	public Spotify() {
		super();
	}
	...
	/**
	* Default Spotify constructor
	*/
	public Spotify(int monto, List<Usuario> usuarios) {
		super();
		this.monto = monto;
